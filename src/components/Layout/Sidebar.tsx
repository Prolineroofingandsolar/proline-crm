...
import { LayoutDashboard, Users, Briefcase, CheckSquare, Calendar, Contact, FolderOpen, BarChart2, Settings, ChevronDown, Kanban, LogOut, Clock, Receipt, Landmark } from 'lucide-react';
...
const ALL_NAV = [
  ...
  { id: 'banking',   label: 'Banking',   icon: Landmark,        adminOnly: true },
