...
struct MacSettingsView: View {
    ...
    private func stageColor(_ stage: LeadStage) -> Color { switch stage { case .newLead: .blue; case .surveyBooked: .orange; case .quotePreparing, .quoteSent: .purple; case .won, .paid: .green; case .scheduled: .teal; case .inProgress: .cyan; case .completed: .mint; case .lost: .gray } }
    private func stageDescription(_ stage: LeadStage) -> String { switch stage { case .newLead: "A new customer enquiry awaiting contact."; case .surveyBooked: "A roof survey has been arranged."; case .quotePreparing: "Measurements and pricing are being prepared."; case .quoteSent: "The customer has received a quotation."; case .won: "The customer accepted the work."; case .scheduled: "Dates, labour and materials are being planned."; case .inProgress: "Work is active on site."; case .completed: "Work is finished and awaiting final settlement."; case .paid: "The account is fully settled."; case .lost: "The opportunity did not proceed." } }
}
